...
public class OpinionTest  {
    ...
    public void run() throws Exception {
        ...
        driver.findElementByAndroidUIAutomator("text(\"发布问题\")").click();
        driver.findElementByAndroidUIAutomator("text(\"账号相关\")").click();
        driver.findElementByAndroidUIAutomator("text(\"产品bug\")").click();
        driver.findElementByAndroidUIAutomator("text(\"投诉\")").click();
        driver.findElementByAndroidUIAutomator("text(\"优化建议\")").click();
        driver.findElementByAndroidUIAutomator("text(\"其它\")").click();

        driver.findElementByClassName("android.widget.EditText").sendKeys("111");

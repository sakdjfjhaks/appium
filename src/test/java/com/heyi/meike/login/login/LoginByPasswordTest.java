package com.heyi.meike.login.login;
...
public class LoginByPasswordTest {
...
//        cap.setCapability("app", "https://meike-packages.oss-cn-qingdao.aliyuncs.com/release/meike_release-v_1.1.2.apk");//安装app

        File file = new File("meikeapp/meike.apk");
        cap.setCapability("app", file.getAbsolutePath());//安装app
